...
public class CLIParser implements Runnable, Cancellable {
	...
	public CLIParser(SimpleServentListener listener, FractalCreator fractalCreator) {
		...
		commandList.add(new MyStatusCommand(fractalCreator));
		commandList.add(new MyStartCommand(fractalCreator));
		commandList.add(new MyResultCommand(fractalCreator));
		commandList.add(new MyStopCommand(fractalCreator));
		commandList.add(new MyQuitCommand());
	}
