...
public class ServentMain {
	...
	public static void main(String[] args) {
		...
		Thread creatorThread = new Thread(fractalCreator);
		creatorThread.start();
		// treba mi while working
		SimpleServentListener simpleListener = new SimpleServentListener(fractalCreator);
		Thread listenerThread = new Thread(simpleListener);
		listenerThread.start();
		
		CLIParser cliParser = new CLIParser(simpleListener, fractalCreator);
